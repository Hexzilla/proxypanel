...
<div>
	<div class="nav-bg">
		<nav class="nav nav-tabs">
			<a class="nav-link active col-md-4 col-lg-4 nav-btn" data-toggle="tab" href="#tabCont1" style="background-color: rgb(135, 96, 251, 0.2);">
			...
			<a class="nav-link col-md-4 col-lg-4 nav-btn" data-toggle="tab" href="#tabCont2" style="background-color: rgba(56, 210, 80, 0.2);">
			...
			<a class="nav-link col-md-4 col-lg-4 nav-btn" data-toggle="tab" href="#tabCont3" style="background-color: rgba(241, 0, 117, 0.2);">
						...
						<div class="card custom-card">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6">
										<p class="mg-b-5">Nickname: </p>
										<input type="text" class="form-control" name="nickName" value="Proxy">
										<p class="text-muted card-sub-title">A unique alphanumeric name for this proxy</p>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6">
										<p class="mg-b-5">Rotation</p>
										<select class="form-control select2-no-search" name="rotation">
											<option label="No rotation"></option>
											<option value="5">
												5 Minutes
											</option>
