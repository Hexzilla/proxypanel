...
<!-- End Prism Precode -->
							...
							<div class="card custom-card" id="complex">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Complex Tab Navigation</h6>
												...
												<div class="card-body tab-content">
													<div class="main-tab-content">
														...
														<div class="main-tab-pane" id="mainTab5">
															...
															<span>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which does not look even slightly believable. </span>
														</div>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="nav9"><pre><code class="language-markup"><script type="html-dashlead/script"><div class="border">
	<div class="card-header-tab">
