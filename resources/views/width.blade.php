					...
					<div class="row">
						<div class="col-xl-9 col-lg-12">
							<div class="card custom-card" id="set">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Set Width</h6>
							...
							<div class="card custom-card" id="percentage">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Percentage Width</h6>
							...
							<div class="card custom-card" id="media">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Media Query Width</h6>
							...
							<div class="card custom-card" id="extra">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Extra Width Classes</h6>
